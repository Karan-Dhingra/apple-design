...
import { explore2Img } from './../utils/index';
...
const Features = () => {
    ...
    useGSAP(() => {
        ...
        animateWithGsap('.g_grow', {scale: 1, ease: 'power1', opacity: 1}, {scrub: 5.5})
        animateWithGsap('.g_text', {scale: 1, ease: 'power2.inOut', opacity: 1, duration: 1}, {})
    }, [])
            ...
            <div className='screen-max-width'>
                ...
                <div className='flex-center flex-col sm:px-10'>
                    <div className='relative h-[50vh] w-full flex items-center'>
                        <video playsInline={true} id='exploreVideo' className='w-full h-full object-cover object-center' preload='none' autoPlay muted ref={videoRef} >
                    ...
                    <div className='feature-text-container'>
                        <div className='flex-1 flex-center'>
                            <p className='feature-text g_text'>iPhone 15 Pro is {' '}
                                ...
                                using the same alloy that spacecrafts used for missions to Mars.
                            </p>
                        </div>
                        <div className='flex-1 flex-center'>
                            <p className='feature-text g_text'>Titanium has one of the best strength-to-weights ratios of any metal, making these our {' '}
